package trying.miniplc0java.error;
...
public enum ErrorCode {
    ...
    StringLiteralOpen, CharacterLiteralOpen, InvalidEscapeCharacter, InvalidCharacterLiteral, InvalidDoubleLiteral,
    InvalidFunctionParamDeclaration,InvalidFunctionReturnType, InvalidType, InvalidElseStatement
}
